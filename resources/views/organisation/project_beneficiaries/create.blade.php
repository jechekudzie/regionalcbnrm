            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0" id="page-title">{{$organisation->name}}  - {{$project->name}} Beneficiaries</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form action="{{ route('organisation.project-beneficiaries.store', [$organisation->slug, $project->slug]) }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="beneficiary_number" class="form-label">Number of Beneficiaries</label>
                                                        <input type="number" class="form-control" id="beneficiary_number" name="beneficiary_number" placeholder="Enter number of beneficiaries">
                                                    </div>
                                                </div>
                                            </div>
