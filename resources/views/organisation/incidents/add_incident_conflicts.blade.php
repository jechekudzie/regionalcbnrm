                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    ...
                                    <button class="btn btn-success add-btn" data-bs-toggle="modal"
                                            ...
                                            class="fa fa-plus"></i> Add Incident Conflict
                                    </button>
                                </div>
                            ...
                            <div class="modal-content border-0">
                                ...
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('organisation.incident-conflict-types.store',[$organisation->slug, $incident->slug])}}"
                                              method="POST">
                                            @csrf
                                                        ...
                                                        <div class="col-md-3 col-lg-3 mb-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                       ...
                                                                       id="conflict_types{{ $conflictType->id }}" name="conflict_types[]">
                                                                <label class="form-check-label"
                                                                       for="conflict_types{{ $conflictType->id }}">
                                                                    {{ $conflictType->name }}
                                                                </label>
                                                            </div>
                                                        </div>
