                                ...
                                <table style="width: 100%;" id="buttons-datatables"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                            rowspan="1" colspan="1"
                                            aria-label="Position: activate to sort column ascending"
                                            style="width: 336.4px;">Payable Items
                                        </th>
                                    ...
                                    @foreach($categories as $category)
                                        <tr class="even">
                                            ...
                                            <td>
                                                <a href="{{ route('organisation.payable-items.index', [$organisation->slug, $category->slug]) }}">
                                                    Organisation Payable Item ({{ $organisation->organisationPayableItems()
                                                    ->whereHas('payableItem', function ($query) use ($category) {
