        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Hunting Records Overview</h4>
                        </div>
                        <div class="card-body">
                            <canvas id="huntingRecordsChart" height="500"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Conflict Data Overview</h4>
                        </div>
                        <div class="card-body">
                            <canvas id="conflictDataChart" height="500"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Control Cases Overview</h4>
                        </div>
                        <div class="card-body">
                            <canvas id="controlCasesChart" height="500"></canvas>
                        </div>
                    </div>
                </div>
            </div>
