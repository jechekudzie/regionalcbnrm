                ...
                <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('admin.species-gender.index')}}"
                                       class="nav-link {{ Request::routeIs('admin.species-gender*') ? 'active' : '' }}">
                                        Species Gender
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{route('admin.maturity.index')}}"
                                       class="nav-link {{ Request::routeIs('admin.maturity.index*') ? 'active' : '' }}">
                                        Species Maturity
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="hwc">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{route('admin.conflict-types.index')}}" class="nav-link ">
                                        Incident Types
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('admin.conflict-outcomes.index')}}"
                                       class="nav-link {{ Request::routeIs('admin.conflict-types*') ? 'active' : '' }}">
                                        Conflict Outcomes
                                    </a>
                                </li>
                            </ul>
