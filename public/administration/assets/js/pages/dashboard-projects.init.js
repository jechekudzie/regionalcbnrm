...
linechartcustomerColors && (options = {
    ...
    }, {name: "Hunted", type: "bar", data: [8, 12, 7, 17, 21, 11, 5, 9, 7, 29, 12, 35]}],
    ...
    xaxis: {
        categories: ["Elephant", "Lion", "Leopard", "Buffalo", "Crocodile", "Hippo", "Hyena Spotted", "Hyena Brown", "Wild Dogs", "Jackle", "Wild Pigs", "Antelops"],
        axisTicks: {show: !1},
        axisBorder: {show: !1}
    },
    grid: {
...
var isApexSeriesData = {}, isApexSeries = document.querySelectorAll("[data-chart-series]");
isApexSeries && Array.from(isApexSeries).forEach(function (e) {
    var t = e.attributes;
...
var options, chart, donutchartProjectsStatusColors = getChartColorsArray("prjects-status");
donutchartProjectsStatusColors && (options = {
    series: [125, 42, 58, 89],
